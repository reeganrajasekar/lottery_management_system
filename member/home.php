                    ...
                    <div class="card bg-gradient-success card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $sql = "SELECT token FROM token WHERE memberid='$memberid' AND DATE(reg_date)='$newdate'";
                    ...
                    <div class="card bg-gradient-primary card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $date=date_create();
                                $newdate = date_format($date,"Y-m-d");
                                $sql = "SELECT token FROM token WHERE memberid='$memberid' AND time='DO-01pm' AND DATE(reg_date)='$newdate'";
                                $result = $conn->query($sql);
                                $data1 = "[";
                                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="card bg-gradient-info card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $date=date_create();
                                $newdate = date_format($date,"Y-m-d");
                                $sql = "SELECT token FROM token WHERE memberid='$memberid' AND time='BU-02pm' AND DATE(reg_date)='$newdate'";
                                $result = $conn->query($sql);
                                $data2 = "[";
                                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="card bg-gradient-danger card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $date=date_create();
                                $newdate = date_format($date,"Y-m-d");
                                $sql = "SELECT token FROM token WHERE memberid='$memberid' AND time='KL-03pm' AND DATE(reg_date)='$newdate'";
                                $result = $conn->query($sql);
                                $data3 = "[";
                                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="card bg-gradient-warning card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $date=date_create();
                                $newdate = date_format($date,"Y-m-d");
                                $sql = "SELECT token FROM token WHERE memberid='$memberid' AND time='BU-07pm' AND DATE(reg_date)='$newdate'";
                                $result = $conn->query($sql);
                                $data7 = "[";
                                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="card bg-gradient-secondary card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $date=date_create();
                                $newdate = date_format($date,"Y-m-d");
                                $sql = "SELECT token FROM token WHERE memberid='$memberid' AND time='DO-08pm' AND DATE(reg_date)='$newdate'";
                                $result = $conn->query($sql);
                                $data8 = "[";
                                while ($row = $result->fetch_assoc()) {

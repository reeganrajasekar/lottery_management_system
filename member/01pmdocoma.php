...
<div class="main-panel">
    <div class="container py-4" style="background-color:#f2edf3;min-height:100%">
        ...
        <br>
        <form onsubmit="document.getElementById('final').disabled=true;" action="/member/action/01pm.php" method="post">
            <input type="hidden" name="time" value="DO-01pm">
                    ...
                    <script>
                        ...
                        function addBox(){
                            ...
                            if(onev && onetype && oneqty){
                                ...
                                alert("Select Type , Token and Qty")
                            }
                        }
                    </script>
                </tbody>

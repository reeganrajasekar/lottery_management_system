        ...
        <?php }else {?>
            ...
            <div class="container mt-3 bg-white border p-4" style="visibility:hidden" id="mypdf">
                <table style="font-size: 12px;">
                    <thead>
                        <tr>
                            <th>Agent id :<?php echo $_SESSION["memberid"] ?></th>
                            <th>Agent Name : <?php echo $_SESSION["membername"] ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>Agent Mobile : <?php echo $_SESSION["membermobile"] ?></td>
...
<script>
    ...
    function demoFromHTML() {
        ...
        function (dispose) {
            pdf.save('<?php echo($_SESSION["membername"].'_'.$_GET['date']) ?>.pdf');
        }, margins);
    }

...
$t=time();
if((date("G",$t)=="19" && date("i",$t)>"30" ) || (date("G",$t)=="20" && date("i",$t)<"30")){
    header("Location:/member/token.php?err=07pm - Bhuttan Tickets Closed!");
    die();
}
?>
...
<div class="main-panel">
    <div class="container py-4" style="background-color:#f2edf3;min-height:100%">
        <h4 class="text-secondary">
            07pm - BHUTTAN <?php if(date("G",$t)>="20"){?><span class="text-danger">( Tomorrow Token )</span><?php } ?>
        </h4>
        <br>
        ...
        <br>
        <form onsubmit="document.getElementById('final').disabled=true;" action="/member/action/07pm.php" method="post">
            <input type="hidden" name="time" value="BU-07pm">
